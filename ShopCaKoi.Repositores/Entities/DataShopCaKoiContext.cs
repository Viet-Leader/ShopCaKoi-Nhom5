...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__Booking__C6D03BED0E4FDE73");
            ...
            entity.HasOne(d => d.Acc).WithMany(p => p.Bookings)
                ...
                .HasConstraintName("FK__Booking__AccID__72C60C4A");

            entity.HasOne(d => d.Trip).WithMany(p => p.Bookings)
                .HasForeignKey(d => d.TripId)
                .HasConstraintName("FK__Booking__tripID__73BA3083");
        });

        modelBuilder.Entity<Cart>(entity =>
        {
            entity.HasKey(e => e.CartId).HasName("PK__Cart__51BCD7B775F1AFB3");
        ...
        {
            entity.HasKey(e => e.CartItemId).HasName("PK__CartItem__488B0B0A9367E3F3");
        ...
        {
            entity.HasKey(e => e.Idnv).HasName("PK__Consulti__B87DC9B21C63ABF5");
            ...
            entity.HasOne(d => d.IdnvNavigation).WithOne(p => p.ConsultingStaff)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Consulting__IDNV__787EE5A0");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__B611CB9D832E8AC2");
        ...
        {
            entity.HasKey(e => e.Idnv).HasName("PK__Deliveri__B87DC9B212EFD14C");
            ...
            entity.HasOne(d => d.IdnvNavigation).WithOne(p => p.DeliveringStaff)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Delivering__IDNV__7A672E12");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Feedback__3213E83FA63A977B");

            entity.ToTable("Feedback", tb => tb.HasTrigger("trg_AutoIncrementFeedbackID"));
        ...
        {
            entity.HasKey(e => e.KoiId).HasName("PK__Koi__915924EF257C1CE1");
        ...
        {
            entity.HasKey(e => e.Idnv).HasName("PK__Manager__B87DC9B29B45FAEF");
            ...
            entity.HasOne(d => d.IdnvNavigation).WithOne(p => p.Manager)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Manager__IDNV__7F2BE32F");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__C3905BCFA0789DB6");
        ...
        {
            entity.HasKey(e => e.OrderItemId).HasName("PK__OrderIte__57ED068127031645");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderKoi__0809337D07A0C8E2");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.OrderKois)
                .HasForeignKey(d => d.CustomerId)
                .HasConstraintName("FK__OrderKoi__custom__04E4BC85");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderTri__C3905BAF0ABBDB77");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.OrderTrips)
                .HasForeignKey(d => d.CustomerId)
                .HasConstraintName("FK__OrderTrip__custo__07C12930");

            entity.HasOne(d => d.Quotation).WithMany(p => p.OrderTrips)
                .HasForeignKey(d => d.QuotationId)
                .HasConstraintName("FK__OrderTrip__quota__08B54D69");

            entity.HasOne(d => d.Trip).WithMany(p => p.OrderTrips)
                .HasForeignKey(d => d.TripId)
                .HasConstraintName("FK__OrderTrip__tripI__09A971A2");
        });

        modelBuilder.Entity<Quotation>(entity =>
        {
            entity.HasKey(e => e.QuotationId).HasName("PK__Quotatio__7536E372A52B9B18");
        ...
        {
            entity.HasKey(e => e.Idnv).HasName("PK__SalesSta__B87DC9B29A49A521");
            ...
            entity.HasOne(d => d.IdnvNavigation).WithOne(p => p.SalesStaff)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__SalesStaff__IDNV__0A9D95DB");
        ...
        {
            entity.HasKey(e => e.AccId).HasName("PK__ShopCaKo__91CBC3983D8FF196");

            entity.ToTable("ShopCaKoiAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__ShopCaKo__49A147403E1A4F03").IsUnique();
